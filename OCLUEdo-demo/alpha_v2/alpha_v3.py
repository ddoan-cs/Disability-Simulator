...
SLOTS = {
    ...
    # Positive Events
    0: {"type": "positive", "message": "You went to an amusement park with your family.", "cost": (5, 5)},
    1: {"type": "positive", "message": "You went to the movies with your friends.", "cost": (5, 2)},
    2: {"type": "positive", "message": "You went to your favorite concert.", "cost": (5, 2)},
    3: {"type": "positive", "message": "You went to a baseball game.", "cost": (5, 2)},
    4: {"type": "positive", "message": "You had enough energy to clean the house.", "cost": (5, 2)},

    # Negative Events
    5: {"type": "negative", "message": "You weren't able to sleep last night, so you woke up tired", "cost": (-5, -2)},
    6: {"type": "negative", "message": "Your weren't able to do anything because your back pain increased.", "cost": (-5, -4)},
    7: {"type": "negative", "message": "You went grocery shopping", "cost": (0, -1)},
    8: {"type": "negative", "message": "You suddenly had a migraine.", "cost": (-5, -5)},
    9: {"type": "negative", "message": "You were too tired to cook, so you didn't eat.", "cost": (-5, -5)},


    # Start
    10: {"type": "start", "message": "You have just started your last month of university when you have suddenly developed symptoms of some unknown cause.", "cost": None},

    # End
    11: {"type": "end", "message": "You were able to finish your last month and graduate!", "cost": None}
}
#</COMMON_DATA>
...
class State():
  ...
  def handle_event(self):
    ...
    if new_happiness < 0: 
       ...
       self.d["players"][current_player].d["happiness"] = 100
    else:
